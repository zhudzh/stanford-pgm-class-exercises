...
for geno_index = 1:numPeople,
    ...
    if (pa == [0,0]),
        factorList(geno_index) = ...
            genotypeGivenAlleleFreqsFactor(alleleFreqs, ...
                                           geno_index);
    else
        factorList(geno_index) = ...
            genotypeGivenParentsGenotypesFactor(numAlleles, geno_index, ...
                                                pa(1), pa(2));
    end
end

for pheno_index = numPeople+1:numPeople*2,
    factorList(pheno_index) = ...
        phenotypeGivenGenotypeFactor(alphaList, pheno_index - numPeople, ...
                                     pheno_index);
end
