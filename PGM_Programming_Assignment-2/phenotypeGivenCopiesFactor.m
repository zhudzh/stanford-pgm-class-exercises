...
card = numAlleles + factorial(numAlleles)/ ...
    (factorial(numAlleles - 2) * 2);
...
for i=1:numAlleles,
    for j=1:numAlleles,
        geno_type = allelesToGenotypes(i,j);
        phenotypeFactor.val(k) = alphaList(geno_type);
        k += 1;
        phenotypeFactor.val(k) = 1 - alphaList(geno_type);
        k += 1;
    end
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%